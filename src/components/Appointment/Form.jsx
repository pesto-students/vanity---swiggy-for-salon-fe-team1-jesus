        ...
        <div className="flex flex-col w-1/2 phone:w-full pr-10 phone:pr-0">
            ...
            <div className="flex flex-col space-y-10 py-6">
                <label className="relative w-full block bg-white p-3 border-2 border-black rounded" htmlFor="name">
                    <input
                        className="w-full px-0 bg-white pt-3.5 pb-0 outline-none text-sm placeholder-transparent border-none focus:ring-0 peer"
                        id="name"
                        type="text"
                        value={appUser.name}
                ...
                <label className="relative w-full block p-3 bg-white border-2 border-black rounded" htmlFor="email">
                    <input
                        className="w-full px-0  bg-white pt-3.5 pb-0 outline-none text-sm placeholder-transparent border-none focus:ring-0 peer"
                        id="email"
                        type="email"
                ...
                <label className="relative w-full block p-3 bg-white border-2 border-black rounded" htmlFor="phone">
                    <input
                        className="w-full px-0  bg-white pt-3.5 pb-0 outline-none text-sm placeholder-transparent border-none focus:ring-0 peer"
                        id="phone"
                        type="text"
